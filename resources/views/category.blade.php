...
<div class="search-container" style="position: absolute; width: 100%; z-index: 5; background-color: #ccc;">
    <form id="search-form" action="{{ route('category.show', ['category_id' => $category->category_id]) }}" method="get" style="margin: 20px 40px;">
        <div class="input-group">
            <input type="search" class="form-control" placeholder="Search about {{$category->title}}" required
...
<div class="main-container" style="padding-top: 78px">
     <div class="row" style="height: 100%; overflow: auto;">
        <div class="filter-container col-3" style="padding: 20px 40px; border-right: 1px solid #ccc; margin-top: 20px;">
            <form id="filter-form" action="{{ route('category.show', ['category_id' => $category->category_id]) }}" method="get">
...
<script>
    $(document).ready(function() {
        // Listen for the change event on checkboxes and select elements
